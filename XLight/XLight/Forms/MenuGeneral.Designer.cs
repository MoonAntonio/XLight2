namespace XLight
{
	partial class MenuGeneral
	{
		...
		private void InitializeComponent()
		{
			...
			this.progressMensual = new VisualPlus.Toolkit.Controls.DataVisualization.VisualRadialProgress();
			this.bunifuSeparator1 = new Bunifu.Framework.UI.BunifuSeparator();
			this.lblCard3 = new Bunifu.Framework.UI.BunifuCustomLabel();
			this.lblCard2 = new Bunifu.Framework.UI.BunifuCustomLabel();
			this.lblCard1 = new Bunifu.Framework.UI.BunifuCustomLabel();
			...
			this.lblConectado = new Bunifu.Framework.UI.BunifuCustomLabel();
			...
			this.transi1.SetDecoration(this.panelControl, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.separadorInferior, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.separadorSuperior, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.header, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.lblSuperior, BunifuAnimatorNS.DecorationType.None);
			...
			this.panelControlAnimator.DefaultAnimation = animation3;
			// 
			...
			this.panelControlAnimator2.SetDecoration(this.PanelClientes, BunifuAnimatorNS.DecorationType.None);
			this.PanelClientes.Dock = System.Windows.Forms.DockStyle.Fill;
			this.PanelClientes.ForeColor = System.Drawing.SystemColors.ControlText;
			this.PanelClientes.GradientBottomLeft = System.Drawing.Color.DarkBlue;
			this.PanelClientes.GradientBottomRight = System.Drawing.Color.Black;
			this.PanelClientes.GradientTopLeft = System.Drawing.Color.FromArgb(((int)(((byte)(251)))), ((int)(((byte)(97)))), ((int)(((byte)(122)))));
			this.PanelClientes.GradientTopRight = System.Drawing.Color.DarkTurquoise;
			this.PanelClientes.Location = new System.Drawing.Point(256, 53);
			this.PanelClientes.Name = "PanelClientes";
			this.PanelClientes.Quality = 10;
			...
			this.transi1.SetDecoration(this.panelDashboard, BunifuAnimatorNS.DecorationType.None);
			...
			this.panelStats.Controls.Add(this.bunifuSeparator2);
			this.panelStats.Controls.Add(this.bunifuCustomLabel5);
			this.panelStats.Controls.Add(this.progressMensual);
			this.panelStats.Controls.Add(this.bunifuSeparator1);
			this.panelStats.Controls.Add(this.lblCard3);
			this.panelStats.Controls.Add(this.lblCard2);
			this.panelStats.Controls.Add(this.lblCard1);
			this.panelStats.Controls.Add(this.card3);
			this.panelStats.Controls.Add(this.card2);
			this.panelStats.Controls.Add(this.card1);
			this.transi1.SetDecoration(this.panelStats, BunifuAnimatorNS.DecorationType.None);
			...
			this.panelStats.Size = new System.Drawing.Size(932, 227);
			...
			this.transi1.SetDecoration(this.bunifuSeparator2, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.bunifuSeparator2, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.bunifuSeparator2, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator2.SetDecoration(this.bunifuSeparator2, BunifuAnimatorNS.DecorationType.None);
			this.bunifuSeparator2.ForeColor = System.Drawing.SystemColors.ControlDarkDark;
			this.bunifuSeparator2.LineColor = System.Drawing.Color.FromArgb(((int)(((byte)(105)))), ((int)(((byte)(105)))), ((int)(((byte)(105)))));
			this.bunifuSeparator2.LineThickness = 1;
			this.bunifuSeparator2.Location = new System.Drawing.Point(751, 42);
			this.bunifuSeparator2.Name = "bunifuSeparator2";
			this.bunifuSeparator2.Size = new System.Drawing.Size(152, 15);
			...
			this.panelControlAnimator2.SetDecoration(this.bunifuCustomLabel5, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.bunifuCustomLabel5, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.bunifuCustomLabel5, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.bunifuCustomLabel5, BunifuAnimatorNS.DecorationType.None);
			this.bunifuCustomLabel5.Font = new System.Drawing.Font("Segoe UI Semibold", 18.25F, System.Drawing.FontStyle.Bold);
			this.bunifuCustomLabel5.ForeColor = System.Drawing.Color.DimGray;
			this.bunifuCustomLabel5.Location = new System.Drawing.Point(768, 13);
			this.bunifuCustomLabel5.Name = "bunifuCustomLabel5";
			this.bunifuCustomLabel5.Size = new System.Drawing.Size(112, 35);
			this.bunifuCustomLabel5.TabIndex = 9;
			this.bunifuCustomLabel5.Text = "Mensual";
			// 
			// progressMensual
			// 
			this.progressMensual.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)));
			this.progressMensual.BackCircleColor = System.Drawing.Color.FromArgb(((int)(((byte)(46)))), ((int)(((byte)(72)))), ((int)(((byte)(80)))));
			this.progressMensual.BackColor = System.Drawing.Color.Transparent;
			this.panelControlAnimator2.SetDecoration(this.progressMensual, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.progressMensual, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.progressMensual, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.progressMensual, BunifuAnimatorNS.DecorationType.None);
			this.progressMensual.Font = new System.Drawing.Font("Segoe UI Semibold", 20.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.progressMensual.ForeCircle = System.Drawing.Color.FromArgb(((int)(((byte)(26)))), ((int)(((byte)(32)))), ((int)(((byte)(40)))));
			this.progressMensual.ForeColor = System.Drawing.Color.White;
			this.progressMensual.Image = null;
			this.progressMensual.ImageLocation = new System.Drawing.Point(0, 0);
			this.progressMensual.ImageSize = new System.Drawing.Size(16, 16);
			this.progressMensual.LargeChange = 5;
			this.progressMensual.LineCap = System.Drawing.Drawing2D.LineCap.Round;
			this.progressMensual.Location = new System.Drawing.Point(751, 63);
			this.progressMensual.Maximum = 100;
			this.progressMensual.Minimum = 0;
			this.progressMensual.MinimumSize = new System.Drawing.Size(100, 100);
			this.progressMensual.MouseState = VisualPlus.Enumerators.MouseStates.Normal;
			this.progressMensual.Name = "progressMensual";
			this.progressMensual.ProgressColor = System.Drawing.Color.Lime;
			this.progressMensual.Size = new System.Drawing.Size(152, 152);
			this.progressMensual.SmallChange = 1;
			this.progressMensual.SubscriptColor = System.Drawing.Color.FromArgb(((int)(((byte)(188)))), ((int)(((byte)(23)))), ((int)(((byte)(8)))));
			this.progressMensual.SubscriptFont = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.progressMensual.SubscriptLocation = new System.Drawing.Point(70, 50);
			this.progressMensual.SubscriptText = "";
			this.progressMensual.SuperscriptColor = System.Drawing.Color.FromArgb(((int)(((byte)(9)))), ((int)(((byte)(36)))), ((int)(((byte)(188)))));
			this.progressMensual.SuperscriptFont = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.progressMensual.SuperscriptLocation = new System.Drawing.Point(70, 35);
			this.progressMensual.SuperscriptText = "";
			this.progressMensual.TabIndex = 8;
			this.progressMensual.Text = "visualRadialProgress1";
			this.progressMensual.TextStyle.Disabled = System.Drawing.Color.FromArgb(((int)(((byte)(131)))), ((int)(((byte)(129)))), ((int)(((byte)(129)))));
			this.progressMensual.TextStyle.Enabled = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(0)))));
			this.progressMensual.TextStyle.Hover = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(0)))));
			this.progressMensual.TextStyle.Pressed = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(0)))));
			this.progressMensual.TextStyle.TextAlignment = System.Drawing.StringAlignment.Center;
			this.progressMensual.TextStyle.TextLineAlignment = System.Drawing.StringAlignment.Center;
			this.progressMensual.TextStyle.TextRenderingHint = System.Drawing.Text.TextRenderingHint.ClearTypeGridFit;
			this.progressMensual.TextVisible = false;
			this.progressMensual.Value = 20;
			// 
			// bunifuSeparator1
			// 
			...
			this.transi1.SetDecoration(this.bunifuSeparator1, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.bunifuSeparator1, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.bunifuSeparator1, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator2.SetDecoration(this.bunifuSeparator1, BunifuAnimatorNS.DecorationType.None);
			this.bunifuSeparator1.ForeColor = System.Drawing.SystemColors.ControlDarkDark;
			this.bunifuSeparator1.LineColor = System.Drawing.Color.FromArgb(((int)(((byte)(105)))), ((int)(((byte)(105)))), ((int)(((byte)(105)))));
			this.bunifuSeparator1.LineThickness = 1;
			this.bunifuSeparator1.Location = new System.Drawing.Point(51, 42);
			this.bunifuSeparator1.Name = "bunifuSeparator1";
			this.bunifuSeparator1.Size = new System.Drawing.Size(648, 15);
			...
			// lblCard3
			// 
			this.lblCard3.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)));
			this.lblCard3.AutoSize = true;
			this.panelControlAnimator2.SetDecoration(this.lblCard3, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.lblCard3, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.lblCard3, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.lblCard3, BunifuAnimatorNS.DecorationType.None);
			this.lblCard3.Font = new System.Drawing.Font("Segoe UI Semibold", 18.25F, System.Drawing.FontStyle.Bold);
			this.lblCard3.ForeColor = System.Drawing.Color.DimGray;
			this.lblCard3.Location = new System.Drawing.Point(559, 14);
			this.lblCard3.Name = "lblCard3";
			this.lblCard3.Size = new System.Drawing.Size(114, 35);
			this.lblCard3.TabIndex = 6;
			this.lblCard3.Text = "Cambios";
			// 
			// lblCard2
			// 
			this.lblCard2.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)));
			this.lblCard2.AutoSize = true;
			this.panelControlAnimator2.SetDecoration(this.lblCard2, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.lblCard2, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.lblCard2, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.lblCard2, BunifuAnimatorNS.DecorationType.None);
			this.lblCard2.Font = new System.Drawing.Font("Segoe UI Semibold", 18.25F, System.Drawing.FontStyle.Bold);
			this.lblCard2.ForeColor = System.Drawing.Color.DimGray;
			this.lblCard2.Location = new System.Drawing.Point(307, 14);
			this.lblCard2.Name = "lblCard2";
			this.lblCard2.Size = new System.Drawing.Size(138, 35);
			this.lblCard2.TabIndex = 5;
			this.lblCard2.Text = "Conectado";
			// 
			// lblCard1
			// 
			...
			this.panelControlAnimator2.SetDecoration(this.lblCard1, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.lblCard1, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.lblCard1, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.lblCard1, BunifuAnimatorNS.DecorationType.None);
			this.lblCard1.Font = new System.Drawing.Font("Segoe UI Semibold", 18.25F, System.Drawing.FontStyle.Bold);
			this.lblCard1.ForeColor = System.Drawing.Color.DimGray;
			this.lblCard1.Location = new System.Drawing.Point(77, 14);
			this.lblCard1.Name = "lblCard1";
			this.lblCard1.Size = new System.Drawing.Size(106, 35);
			this.lblCard1.TabIndex = 4;
			this.lblCard1.Text = "Clientes";
			// 
			// card3
			// 
			...
			this.card3.Controls.Add(this.bunifuCustomLabel4);
			this.card3.Controls.Add(this.bunifuCustomLabel3);
			this.card3.Controls.Add(this.pictureBox3);
			this.transi1.SetDecoration(this.card3, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.card3, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.card3, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator2.SetDecoration(this.card3, BunifuAnimatorNS.DecorationType.None);
			...
			this.card3.Location = new System.Drawing.Point(497, 63);
			this.card3.Name = "card3";
			this.card3.Quality = 50;
			this.card3.Size = new System.Drawing.Size(235, 151);
			...
			this.panelControlAnimator2.SetDecoration(this.bunifuCustomLabel4, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.bunifuCustomLabel4, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.bunifuCustomLabel4, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.bunifuCustomLabel4, BunifuAnimatorNS.DecorationType.None);
			this.bunifuCustomLabel4.Font = new System.Drawing.Font("Segoe UI Semibold", 18.25F, System.Drawing.FontStyle.Bold);
			this.bunifuCustomLabel4.ForeColor = System.Drawing.Color.White;
			this.bunifuCustomLabel4.Location = new System.Drawing.Point(25, 100);
			this.bunifuCustomLabel4.Name = "bunifuCustomLabel4";
			this.bunifuCustomLabel4.Size = new System.Drawing.Size(159, 35);
			this.bunifuCustomLabel4.TabIndex = 11;
			this.bunifuCustomLabel4.Text = "125 Cambios";
			// 
			// bunifuCustomLabel3
			// 
			...
			this.panelControlAnimator2.SetDecoration(this.bunifuCustomLabel3, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.bunifuCustomLabel3, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.bunifuCustomLabel3, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.bunifuCustomLabel3, BunifuAnimatorNS.DecorationType.None);
			this.bunifuCustomLabel3.Font = new System.Drawing.Font("Segoe UI Semibold", 11.25F, System.Drawing.FontStyle.Bold);
			this.bunifuCustomLabel3.ForeColor = System.Drawing.Color.White;
			this.bunifuCustomLabel3.Location = new System.Drawing.Point(18, 80);
			this.bunifuCustomLabel3.Name = "bunifuCustomLabel3";
			this.bunifuCustomLabel3.Size = new System.Drawing.Size(140, 20);
			this.bunifuCustomLabel3.TabIndex = 11;
			this.bunifuCustomLabel3.Text = "Cambios realizados";
			// 
			// pictureBox3
			// 
			this.pictureBox3.BackColor = System.Drawing.Color.Transparent;
			this.panelControlAnimator2.SetDecoration(this.pictureBox3, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.pictureBox3, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.pictureBox3, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.pictureBox3, BunifuAnimatorNS.DecorationType.None);
			this.pictureBox3.Image = global::XLight.Properties.Resources.Google_Calendar_100px;
			...
			this.card2.Controls.Add(this.lblConectado);
			this.card2.Controls.Add(this.bunifuCustomLabel2);
			this.card2.Controls.Add(this.pictureBox2);
			this.transi1.SetDecoration(this.card2, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.card2, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.card2, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator2.SetDecoration(this.card2, BunifuAnimatorNS.DecorationType.None);
			...
			this.card2.Location = new System.Drawing.Point(256, 63);
			this.card2.Name = "card2";
			this.card2.Quality = 50;
			this.card2.Size = new System.Drawing.Size(235, 151);
			this.card2.TabIndex = 2;
			// 
			// lblConectado
			// 
			this.lblConectado.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)));
			this.lblConectado.AutoSize = true;
			this.lblConectado.BackColor = System.Drawing.Color.Transparent;
			this.panelControlAnimator2.SetDecoration(this.lblConectado, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.lblConectado, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.lblConectado, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.lblConectado, BunifuAnimatorNS.DecorationType.None);
			this.lblConectado.Font = new System.Drawing.Font("Segoe UI Semibold", 18.25F, System.Drawing.FontStyle.Bold);
			this.lblConectado.ForeColor = System.Drawing.Color.White;
			this.lblConectado.Location = new System.Drawing.Point(16, 100);
			this.lblConectado.Name = "lblConectado";
			this.lblConectado.Size = new System.Drawing.Size(101, 35);
			this.lblConectado.TabIndex = 10;
			this.lblConectado.Text = "4.500 s.";
			// 
			// bunifuCustomLabel2
			// 
			...
			this.panelControlAnimator2.SetDecoration(this.bunifuCustomLabel2, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.bunifuCustomLabel2, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.bunifuCustomLabel2, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.bunifuCustomLabel2, BunifuAnimatorNS.DecorationType.None);
			this.bunifuCustomLabel2.Font = new System.Drawing.Font("Segoe UI Semibold", 11.25F, System.Drawing.FontStyle.Bold);
			...
			this.bunifuCustomLabel2.Text = "Tiempo conectado";
			// 
			// pictureBox2
			// 
			this.pictureBox2.BackColor = System.Drawing.Color.Transparent;
			this.panelControlAnimator2.SetDecoration(this.pictureBox2, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.pictureBox2, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.pictureBox2, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.pictureBox2, BunifuAnimatorNS.DecorationType.None);
			this.pictureBox2.Image = global::XLight.Properties.Resources.SimplyBuilt_100px;
			...
			this.panelControlAnimator.SetDecoration(this.card1, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator2.SetDecoration(this.card1, BunifuAnimatorNS.DecorationType.None);
			...
			this.card1.Location = new System.Drawing.Point(15, 63);
			this.card1.Name = "card1";
			this.card1.Quality = 50;
			this.card1.Size = new System.Drawing.Size(235, 151);
			...
			this.panelControlAnimator2.SetDecoration(this.bunifuCustomLabel1, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.bunifuCustomLabel1, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.bunifuCustomLabel1, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.bunifuCustomLabel1, BunifuAnimatorNS.DecorationType.None);
			this.bunifuCustomLabel1.Font = new System.Drawing.Font("Segoe UI Semibold", 11.25F, System.Drawing.FontStyle.Bold);
			this.bunifuCustomLabel1.ForeColor = System.Drawing.Color.White;
			this.bunifuCustomLabel1.Location = new System.Drawing.Point(18, 80);
			...
			this.panelControlAnimator2.SetDecoration(this.pictureBox1, BunifuAnimatorNS.DecorationType.None);
			this.transi1.SetDecoration(this.pictureBox1, BunifuAnimatorNS.DecorationType.None);
			this.panelControlAnimator.SetDecoration(this.pictureBox1, BunifuAnimatorNS.DecorationType.None);
			this.logoAnimator.SetDecoration(this.pictureBox1, BunifuAnimatorNS.DecorationType.None);
			this.pictureBox1.Image = global::XLight.Properties.Resources.Google_Nearby_100px;
			...
			this.transi1.SetDecoration(this.panelBase, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.h, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.reloj, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.s, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.d, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.m, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.label2, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.label6, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.label5, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.label7, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.label4, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.label8, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.label3, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.btnSalir, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.btnOpciones, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.btnHistorial, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.btnBalance, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.btnClientes, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.btnInicio, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.imgLogoAmpliado, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.btnTransparente, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.bunifuImageButton1, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.btnSlider, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this.btnMaximizar, BunifuAnimatorNS.DecorationType.None);
			...
			this.transi1.SetDecoration(this, BunifuAnimatorNS.DecorationType.None);
		...
		private Bunifu.Framework.UI.BunifuCustomLabel lblCard3;
		private Bunifu.Framework.UI.BunifuCustomLabel lblCard2;
		private Bunifu.Framework.UI.BunifuCustomLabel lblCard1;
		private System.Windows.Forms.PictureBox pictureBox1;
		private System.Windows.Forms.PictureBox pictureBox3;
		private System.Windows.Forms.PictureBox pictureBox2;
		private Bunifu.Framework.UI.BunifuSeparator bunifuSeparator2;
		private Bunifu.Framework.UI.BunifuCustomLabel bunifuCustomLabel5;
		private VisualPlus.Toolkit.Controls.DataVisualization.VisualRadialProgress progressMensual;
